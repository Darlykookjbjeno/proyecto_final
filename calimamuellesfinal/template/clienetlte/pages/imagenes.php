      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <?php include_once("../../../imagenes/vista/agregar.php"); ?>
            <div class="col-sm-1">
              <button class="btn btn-block info " type="submit" name="btnAgregar"  data-toggle="modal" data-target="#agregar">Agregar</button>
            </div>
          </div>
      </section>
          ...
          <?php 
			...
			while($row =$resultado->fetch_assoc()){
                ...
                <div class="col-md-3 col-sm-6 col-12">
                  <div class="info-box">
                  <img src="data:image/jpg;base64, <?php echo base64_encode($row['imagen']);?>" style="width: 70px;"/>

                    <div class="info-box-content">
                      <span class="info-box-text"> id: <?php echo $row['id_imagenesp']; ?></span>
                      <span class="info-box-text"> nombre: <?php echo $row['nombreimagen'];?></span>
                      <span class="info-box-number">id producto: <?php echo $row['id_productos'];?></span>
