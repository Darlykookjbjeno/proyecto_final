                    ...
                    <input type="hidden" name="id" value="<?= $Id; ?>">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="codigo0" name="nombres" value="<?= $info['nombres'] ?>">
                                </div>
                                <div id="datos_ajax_register"></div>
                                <div class="form-group">
                                    <label for="codigo0" class="control-label">Apellidos:</label>
                                    <input type="text" class="form-control" id="codigo0" name="apellidos" value="<?= $info['apellidos'] ?>">
                                </div>
                                <div id="datos_ajax_register"></div>
                                <div class="form-group">
                                    <label for="codigo0" class="control-label">Telefono</label>
                                    <input type="text" class="form-control" id="codigo0" name="telefono" value="<?= $info['telefono'] ?>">
                                </div>
                                <div id="datos_ajax_register"></div>
                                <div class="form-group">
                                    <label for="codigo0" class="control-label">Email:</label>
                                    <input type="text" class="form-control" id="codigo0" name="email" value="<?= $info['email'] ?>">
                                </div>
                        <div>
